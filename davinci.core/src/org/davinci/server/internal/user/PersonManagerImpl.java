...
public class PersonManagerImpl implements PersonManager {
	...
	class UsersFile extends XMLFile {
		...
		protected String[] getAttributeNames() {
			return new String[] { PersonManagerImpl.NAME_TAG,
					PersonManagerImpl.PASSWORD_TAG, PersonManagerImpl.EMAIL_TAG };
		}
		...
		protected String[] getAttributeValues(Object object) {
			...
			return new String[] { user.getUserName(), user.password,
					user.getEmail() };
		}
	...
	private void loadUsers() {
		File userFile = new File(this.baseDirectory,
				IDavinciServerConstants.USER_LIST_FILE);
		if (userFile.exists()) {
