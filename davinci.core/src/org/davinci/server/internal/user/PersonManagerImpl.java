...
public class PersonManagerImpl implements PersonManager {
    ...
    class UsersFile extends XMLFile {
    	protected String getRootTag() {return USERS_TAG;}
    	
    	protected String getElementTag()  {return USER_TAG;}
    	protected String [] getAttributeNames()
    	 {
    		 return new String[]{NAME_TAG,PASSWORD_TAG,EMAIL_TAG};
    	 }
	...
	/* (non-Javadoc)
	 * @see org.davinci.server.user.impl.UserManager#isValidPassword(java.lang.String, java.lang.String)
	 */
	...
	public Person[] getPersons(String userName, int resultNumber, int start){
        ...
        for(String name: names){
        	...
        	if(name.indexOf(userName) >= 0 || email.indexOf(userName) >= 0){
        		if(i >= start && i < start + resultNumber) users.put(email, new PersonImpl(name, "", email));
        		i++;
        	}
        }
