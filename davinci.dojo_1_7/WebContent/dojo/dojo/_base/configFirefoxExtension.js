...
if(dojo.isMoz){
dojo.isFF=parseFloat(_1.split("Firefox/")[1])||undefined;
}
...
var _3=dojo._loadUri;
dojo._loadUri=function(_4,cb){
...
var _7=l.loadSubScript(_4,dojo.global);
if(cb){
cb(_7);
}
return true;
...
_b+="";
_b+=(_b.indexOf("?")==-1?"?":"&")+String(dojo.config.cacheBust).replace(/\W+/g,"");
}
...
dojo.addOnWindowUnload=function(obj,_14){
dojo._onto(dojo._windowUnloaders,obj,_14);
};
var _15=[];
var _16=null;
