...
var i=0,_47=_46[_7],ci=(_45["_i"]||-1),cl=(_46["_l"]||-1);
if(!_47){
return -1;
}
var l=_47.length;
...
if(!("classes" in _6b)){
_4(_6a.classes,function(_6d,idx,arr){
...
var te=_1.byId(_83.id,(_88.ownerDocument||_88));
if(!te||!_86(te)){
return;
}
if(9==_88.nodeType){
...
var _9e=(!!_5()[qsa]&&(!_1.isSafari||(_1.isSafari>3.1)||_9c));
var _9f=/n\+\d|([^ ])?([>~+])([^ =])?/g;
...
var _a9=(_9e&&(!_a5)&&(_8.indexOf(qcz)==-1)&&(!_1.isIE||(_a4.indexOf(":")==-1))&&(!(_6&&(_a4.indexOf(".")>=0)))&&(_a4.indexOf(":contains")==-1)&&(_a4.indexOf(":checked")==-1)&&(_a4.indexOf("|=")==-1));
if(_a9){
