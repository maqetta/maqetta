//>>built
define("dojox/css3/transition",["dojo/_base/kernel","dojo/_base/lang","dojo/_base/declare","dojo/_base/array","dojo/_base/Deferred","dojo/DeferredList","dojo/on","dojo/_base/sniff"],function(_1,_2,_3,_4,_5,_6,on,_7){
...
_3("dojox.css3.transition",null,{constructor:function(_c){
...
dojox.css3.transition.slide=function(_15,_16){
var ret=new dojox.css3.transition(_16);
ret.node=_15;
var _17="0";
var _18="0";
if(ret["in"]){
...
dojox.css3.transition.fade=function(_19,_1a){
var ret=new dojox.css3.transition(_1a);
ret.node=_19;
var _1b="0";
var _1c="0";
if(ret["in"]){
...
dojox.css3.transition.flip=function(_1d,_1e){
var ret=new dojox.css3.transition(_1e);
ret.node=_1d;
if(ret["in"]){
...
if(_22.id&&dojox.css3.transition.playing[_22.id]){
_21.push(dojox.css3.transition.playing[_22.id]);
}
});
return new _6(_21);
};
dojox.css3.transition.getWaitingList=_1f;
dojox.css3.transition.groupedPlay=function(_23){
...
if(_27.node.id){
dojox.css3.transition.playing[_27.node.id]=_27.deferred;
}
});
...
dojox.css3.transition.chainedPlay=function(_2a){
...
if(_2e.node.id){
dojox.css3.transition.playing[_2e.node.id]=_2e.deferred;
}
});
