...
define(["dojo","../..","dojox/math/round"],function(_1,_2){
_1.getObject("drawing.util",true,_2);
var _3={};
var _4=0;
_2.drawing.util.common={radToDeg:function(n){
...
if(_6){
_6=_6/180;
var _7=this.radians(_5),_8=Math.PI*_6,_9=_2.math.round(_7/_8),_a=_9*_8;
return _2.math.round(this.radToDeg(_a));
}else{
