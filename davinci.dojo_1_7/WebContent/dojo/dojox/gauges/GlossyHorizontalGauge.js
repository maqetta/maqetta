...
var th=_6.normalizedLength(_b.size);
...
this._needle=new _9({hideValue:true,title:this.title,noChange:this.noChange,offset:_d,color:this.markerColor,value:this.value});
...
var _e=this._font;
this._computeDataRectangle();
var th=_6.normalizedLength(_e.size);
...
if(_1.number){
return _1.number.format(val,{places:this.scalePrecision});
}else{
...
return _6._base._getTextBox(s,{font:_6.makeFontString(_6.makeParameters(_6.defaultFont,_16))}).w||0;
...
var _18=_1.blendColors(new _1.Color(this.color),new _1.Color("white"),0.4);
this._gaugeBackground=_17.createGroup();
var _19=this.height/this._designHeight;
...
this._gaugeBackground.createRect({x:_1d,y:top,width:w2,height:h2,r:_1c}).setFill({type:"linear",x1:_1d,y1:0,x2:_1d,y2:h-_1a-_1b,colors:[{offset:0,color:_18},{offset:0.2,color:this.color},{offset:0.8,color:this.color},{offset:1,color:_18}]});
var f=4*(Math.sqrt(2)-1)/3*_1c;
this._gaugeBackground.createPath({path:"M"+_1d+" "+(top+_1c)+"C"+_1d+" "+(top+_1c-f)+" "+(_1d+_1c-f)+" "+top+" "+(_1d+_1c)+" "+top+"L"+(_1e-_1c)+" "+top+"C"+(_1e-_1c+f)+" "+top+" "+_1e+" "+(top+_1c-f)+" "+_1e+" "+(top+_1c)+"L"+_1e+" "+(top+h/2)+"L"+_1d+" "+(top+h/3)+"Z"}).setFill({type:"linear",x1:_1d,y1:top,x2:_1d,y2:top+this.height/2,colors:[{offset:0,color:_18},{offset:1,color:_1.blendColors(new _1.Color(this.color),new _1.Color("white"),0.2)}]});
...
this.font=_2e;
this._font=_6.splitFontString(_2e);
this._layoutGauge();
}});
});
