...
var _6=_1.blendColors(new _1.Color(this.color),new _1.Color("white"),0.4);
var _7=_1.blendColors(new _1.Color(this.color),new _1.Color("white"),0.8);
var _8=Math.min((this.width/this._designWidth),(this.height/this._designHeight));
var _9={xx:_8,xy:0,yx:0,yy:_8,dx:-23.33928*_8+(this.width-_8*this._designWidth)/2,dy:-483.30859*_8+(this.height-_8*this._designHeight)/2};
if(this._gaugeBackground){
this._gaugeBackground.setTransform(_9);
...
var _c={xx:_b,xy:0,yx:0,yy:_b,dx:(-160)*_b+(this.width-_b*this._designWidth)/2,dy:(-264.5)*_b+(this.height-_b*this._designHeight)/2};
...
this._foreground.setTransform(_c);
var _f=this._foreground.createGroup().setTransform({xx:1.25,xy:0,yx:0,yy:-1.25,dx:-43.30358,dy:1015.57642});
