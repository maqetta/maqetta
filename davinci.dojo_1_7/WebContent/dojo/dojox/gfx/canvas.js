...
case "pattern":
if(!_2){
_2=document.createElement("canvas");
}
var img=new Image();
...
ctx.moveTo(xl2,yt);
if(r){
ctx.arc(xr2,yt2,r,-_4,0,false);
ctx.arc(xr2,yb2,r,0,_4,false);
ctx.arc(xl2,yb2,r,_4,pi,false);
ctx.arc(xl2,yt2,r,pi,pi+_4,false);
}else{
ctx.lineTo(xr2,yt);
ctx.lineTo(xr,yb2);
ctx.lineTo(xl2,yb);
...
var _56=d.hitch(this,this.onImageLoad);
...
_1.createSurface=function(_57,_58,_59){
if(!_58&&!_59){
var pos=d.position(_57);
_58=_58||pos.w;
_59=_59||pos.h;
}
...
var s=new _1.Surface(),p=d.byId(_57),c=p.ownerDocument.createElement("canvas");
c.width=g.normalizedLength(_58);
c.height=g.normalizedLength(_59);
p.appendChild(c);
s.rawNode=c;
s._parent=p;
s.surface=s;
...
var C=gs.Container,_5a={add:function(_5b){
this.surface.makeDirty();
return C.add.apply(this,arguments);
},remove:function(_5c,_5d){
this.surface.makeDirty();
return C.remove.apply(this,arguments);
},clear:function(){
this.surface.makeDirty();
return C.clear.apply(this,arguments);
},_moveChildToFront:function(_5e){
this.surface.makeDirty();
return C._moveChildToFront.apply(this,arguments);
},_moveChildToBack:function(_5f){
this.surface.makeDirty();
return C._moveChildToBack.apply(this,arguments);
}};
var _60={createObject:function(_61,_62){
var _63=new _61();
_63.surface=this.surface;
_63.setShape(_62);
this.add(_63);
return _63;
}};
d.extend(_1.Group,_5a);
d.extend(_1.Group,gs.Creator);
d.extend(_1.Group,_60);
d.extend(_1.Surface,_5a);
d.extend(_1.Surface,gs.Creator);
d.extend(_1.Surface,_60);
_1.fixTarget=function(_64,_65){
return true;
};
return _1;
});
