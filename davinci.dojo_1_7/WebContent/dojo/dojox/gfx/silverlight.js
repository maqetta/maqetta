...
if(a.source){
ev.target=a.source;
var _41=ev.target.tag;
ev.gfxTarget=dojox.gfx.shape.byId(_41);
}
}
catch(e){
}
...
var _42=_29[s.getHost().content.root.name];
var t=d.position(_42);
ev.clientX=t.x+p.x;
ev.clientY=t.y+p.y;
}
catch(e){
...
var _44={onclick:{name:"MouseLeftButtonUp",fix:_40},onmouseenter:{name:"MouseEnter",fix:_40},onmouseleave:{name:"MouseLeave",fix:_40},onmouseover:{name:"MouseEnter",fix:_40},onmouseout:{name:"MouseLeave",fix:_40},onmousedown:{name:"MouseLeftButtonDown",fix:_40},onmouseup:{name:"MouseLeftButtonUp",fix:_40},onmousemove:{name:"MouseMove",fix:_40},onkeydown:{name:"KeyDown",fix:_43},onkeyup:{name:"KeyUp",fix:_43}};
var _45={connect:function(_46,_47,_48){
var _49,n=_46 in _44?_44[_46]:{name:_46,fix:function(){
return {};
}};
if(arguments.length>2){
_49=this.getEventSource().addEventListener(n.name,function(s,a){
d.hitch(_47,_48)(n.fix(s,a));
});
}else{
_49=this.getEventSource().addEventListener(n.name,function(s,a){
_47(n.fix(s,a));
...
return {name:n.name,token:_49};
},disconnect:function(_4a){
try{
this.getEventSource().removeEventListener(_4a.name,_4a.token);
}
catch(e){
}
}};
d.extend(sl.Shape,_45);
d.extend(sl.Surface,_45);
