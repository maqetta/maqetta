...
var _7={parent:this,_getValueAttr:_1.hitch(this,function(){
return new Date(this._internalValue||this.value);
}),_getDisplayMonthAttr:_1.hitch(this,function(){
return new Date(this.displayMonth);
}),_getConstraintsAttr:_1.hitch(this,function(){
return this.constraints;
}),getLang:_1.hitch(this,function(){
return this.lang;
}),isDisabledDate:_1.hitch(this,this.isDisabledDate),getClassForDate:_1.hitch(this,this.getClassForDate),addFx:this.useFx?_1.hitch(this,this.addFx):function(){
}};
_1.forEach(this._views,function(_8){
var _9=new _8(_7,_1.create("div"));
this.addChild(_9);
var _a=_9.getHeader();
if(_a){
...
_1.style(_9.domNode,"visibility","hidden");
_1.connect(_9,"onValueSelected",this,"_onDateSelected");
_9.set("value",this.get("value"));
},this);
if(this._views.length<2){
_1.style(this.header,"cursor","auto");
}
this.inherited(arguments);
this._children=this.getChildren();
this._currentChild=0;
var _b=new Date();
this.footer.innerHTML="Today: "+_1.date.locale.format(_b,{formatLength:this.footerFormat,selector:"date",locale:this.lang});
_1.connect(this.footer,"onclick",this,"goToToday");
var _c=this._children[0];
_1.style(_c.domNode,"top","0px");
_1.style(_c.domNode,"visibility","visible");
var _d=_c.getHeader();
if(_d){
_1.style(_c.getHeader(),"display","");
}
_1[_c.useHeader?"removeClass":"addClass"](this.container,"no-header");
_c.onDisplay();
var _e=this;
var _f=function(_10,_11,adj){
_2.typematic.addMouseListener(_e[_10],_e,function(_12){
if(_12>=0){
...
if(!_16["getFullYear"]){
_16=_1.date.stamp.fromISOString(_16+"");
}
if(this._isInvalidDate(_16)){
return false;
}
if(!this.value||_1.date.compare(_16,this.value)){
_16=new Date(_16);
...
_1.style(_21.domNode,"visibility","visible");
var _22=_1.style(this.containerNode,"height");
_21.set("value",this.displayMonth);
if(_20.header){
_1.style(_20.header,"display","none");
}
if(_21.header){
_1.style(_21.header,"display","");
}
_1.style(_21.domNode,"top",(_22*-1)+"px");
_1.style(_21.domNode,"visibility","visible");
this._currentChild+=_1f;
var _23=_22*_1f;
var _24=0;
_1.style(_21.domNode,"top",(_23*-1)+"px");
var _25=_1.animateProperty({node:_20.domNode,properties:{top:_23},onEnd:function(){
_1.style(_20.domNode,"visibility","hidden");
}});
var _26=_1.animateProperty({node:_21.domNode,properties:{top:_24},onEnd:function(){
_21.onDisplay();
}});
_1[_21.useHeader?"removeClass":"addClass"](this.container,"no-header");
_25.play();
_26.play();
...
_1[this._currentChild<this._children.length-1?"addClass":"removeClass"](this.header,"navToPanel");
},_slideTable:function(_27,_28,_29){
var _2a=_27.domNode;
var _2b=_2a.cloneNode(true);
var _2c=_1.style(_2a,"width");
_2a.parentNode.appendChild(_2b);
_1.style(_2a,"left",(_2c*_28)+"px");
_29();
var _2d=_1.animateProperty({node:_2b,properties:{left:_2c*_28*-1},duration:500,onEnd:function(){
_2b.parentNode.removeChild(_2b);
}});
var _2e=_1.animateProperty({node:_2a,properties:{left:0},duration:500});
_2d.play();
_2e.play();
...
_1.declare("dojox.widget._CalendarView",_2._Widget,{headerClass:"",useHeader:true,cloneClass:function(_37,n,_38){
var _39=_1.query(_37,this.domNode)[0];
var i;
if(!_38){
for(i=0;i<n;i++){
...
var _3a=_1.query(_37,this.domNode)[0];
for(i=0;i<n;i++){
...
var _40=_1.date.locale.getNames("days",this.dayWidth,"standAlone",this.getLang());
var _41=_1.cldr.supplemental.getFirstDayOfWeek(this.getLang());
_1.query(".dijitCalendarDayLabel",this.domNode).forEach(function(_42,i){
...
var c="dijitCalendar";
var d=_1.hasClass(p,c+"PreviousMonth")?-1:(_1.hasClass(p,c+"NextMonth")?1:0);
if(d){
_43=_1.date.add(_43,"month",d);
}
...
_45.setDate(1);
var _46=_45.getDay();
var _47=_1.date.getDaysInMonth(_45);
var _48=_1.date.getDaysInMonth(_1.date.add(_45,"month",-1));
var _49=new Date();
var _4a=this.get("value");
var _4b=_1.cldr.supplemental.getFirstDayOfWeek(this.getLang());
if(_4b>_46){
_4b-=7;
}
var _4c=_1.date.compare;
...
this._lastDate=_45;
if(!_50){
_1.query(_4d,this.domNode).removeClass(_4e).filter(function(_51){
return _51.className.indexOf("dijitCalendarCurrent")>-1&&_51._date==_4a.getDate();
}).addClass(_4e);
return;
}
_1.query(_4d,this.domNode).forEach(function(_52,i){
i+=_4b;
...
_1.query("."+_59,this.myContainer).forEach(function(_5c,idx){
var _5d=_5b;
switch(idx){
case 0:
_5d=_5a;
case 1:
_1.removeClass(_5c,_59);
_1.addClass(_5c,_5d);
break;
}
});
this._decBtn=_1.query("."+_5a,this.myContainer)[0];
this._incBtn=_1.query("."+_5b,this.myContainer)[0];
_1.query(".dojoxCal-MY-M-Template",this.domNode).filter(function(_5e){
return _5e.cellIndex==1;
}).addClass("dojoxCal-MY-M-last");
_1.connect(this,"onBeforeDisplay",_1.hitch(this,function(){
...
_1.connect(this,"_populateYears",_1.hitch(this,function(){
this._updateSelectedYear();
}));
_1.connect(this,"_populateMonths",_1.hitch(this,function(){
this._updateSelectedMonth();
}));
...
this._monthNames=this._monthNames||_1.date.locale.getNames("months",_60,"standAlone",this.getLang());
return this._monthNames;
},_populateMonths:function(){
var _61=this._getMonthNames("abbr");
_1.query(".dojoxCalendarMonthLabel",this.monthContainer).forEach(_1.hitch(this,function(_62,cnt){
...
_1.query(".dojoxCalendarMonthLabel",this.monthContainer).forEach(_1.hitch(this,function(_67,cnt){
_1[(cnt<min||cnt>max)?"addClass":"removeClass"](_67,"dijitCalendarDisabledDate");
}));
}
...
var _6c=_1.query(".dojoxCalendarYearLabel",this.yearContainer);
var max=_69&&_69.max?_69.max.getFullYear()-_6b:_6c.length;
var _6d="dijitCalendarDisabledDate";
_6c.forEach(_1.hitch(this,function(_6e,cnt){
if(cnt<=max){
this._setText(_6e,_6b+cnt);
_1.removeClass(_6e,_6d);
}else{
_1.addClass(_6e,_6d);
}
}));
if(this._incBtn){
_1[max<_6c.length?"addClass":"removeClass"](this._incBtn,_6d);
}
if(this._decBtn){
_1[min>=_6b?"addClass":"removeClass"](this._decBtn,_6d);
}
var h=this.getHeader();
if(h){
...
this._updateSelectedNode(".dojoxCalendarYearLabel",_1.hitch(this,function(_6f,idx){
...
_1.query(_72,this.domNode).forEach(function(_74,idx,_75){
_1[_73(_74,idx,_75)?"addClass":"removeClass"](_74.parentNode,sel);
});
var _76=_1.query(".dojoxCal-MY-M-Template div",this.myContainer).filter(function(_77){
return _1.hasClass(_77.parentNode,sel);
})[0];
if(!_76){
return;
}
var _78=_1.hasClass(_76,"dijitCalendarDisabledDate");
_1[_78?"addClass":"removeClass"](this.okBtn,"dijitDisabled");
},onClick:function(evt){
var _79;
var _7a=this;
var sel="dijitCalendarSelectedDate";
function hc(c){
return _1.hasClass(evt.target,c);
};
...
_1.stopEvent(evt);
if(_1.hasClass(this.okBtn,"dijitDisabled")){
return false;
}
...
_1.declare("dojox.widget.Calendar2Pane",[_3.widget._CalendarBase,_3.widget._CalendarDay,_3.widget._CalendarMonthYear],{});
_1.declare("dojox.widget.Calendar",[_3.widget._CalendarBase,_3.widget._CalendarDay,_3.widget._CalendarMonthYear],{});
_1.declare("dojox.widget.DailyCalendar",[_3.widget._CalendarBase,_3.widget._CalendarDay],{_makeDate:function(_7b){
var now=new Date();
now.setDate(_7b);
return now;
}});
_1.declare("dojox.widget.MonthAndYearlyCalendar",[_3.widget._CalendarBase,_3.widget._CalendarMonthYear],{});
return _1.getObject("dojox.widget.Calendar");
});
