...
define(["dojo","dijit","dojox","dojo/window","dijit/layout/ContentPane","dijit/_Templated","dijit/_Contained","dijit/layout/_LayoutWidget","dijit/Menu","dijit/form/Button","dijit/focus","dijit/_base/focus","dojox/html/metrics","dojo/i18n","dojo/i18n","dijit/nls/common"],function(_1,_2,_3){
...
this.disconnect(c);
_1.style(this.arrowWrapper,"display","");
});
}else{
_1.style(_78.arrowWrapper,"display","");
}
}else{
...
return _1.getObject("dojox.widget.RollingList");
});
