...
//>>built
define("dojox/widget/rotator/Pan",["dojo","dijit","dojox","dojo/fx"],function(_1,_2,_3){
_1.getObject("dojox.widget.rotator.Pan",1);
(function(d){
...
return _1.getObject("dojox.widget.rotator.Pan");
});
