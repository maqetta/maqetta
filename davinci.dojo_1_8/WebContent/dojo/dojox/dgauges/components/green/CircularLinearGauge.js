...
return _2("dojox.dgauges.components.green.CircularLinearGauge",[_5,_a],{borderColor:[50,50,50],fillColor:[109,183,19],indicatorColor:[0,0,0],constructor:function(_b,_c){
var _d=new _6();
this.addElement("background",_1.hitch(this,this.drawBackground));
var _e=new _7();
_e.set("scaler",_d);
_e.set("originX",132);
_e.set("originY",133.5);
_e.set("radius",100);
_e.set("startAngle",120);
_e.set("endAngle",60);
