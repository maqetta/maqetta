...
var _7=_3.html.format.prettyPrint(this._rte.get("value"));
this._dialog.hide();
var i;
for(i=0;i<this._filters.length;i++){
var _8=this._filters[i];
_7=_7.replace(_8.regexp,_8.handler);
}
_7=_3.html.format.prettyPrint(_7);
