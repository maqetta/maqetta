...
return dojo.declare("dojox.widget._CalendarView",_2,{headerClass:"",useHeader:true,cloneClass:function(_7,n,_8){
...
return this.header||(this.header=this.header=_3.create("span",{"class":this.headerClass}));
