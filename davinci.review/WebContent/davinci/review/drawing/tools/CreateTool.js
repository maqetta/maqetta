...
dojo.declare("davinci.review.drawing.tools.CreateTool", davinci.review.drawing.tools._ToolCommon, {
	...
	deactivate: function(){
		if(!this.surface||!this.surface.isDrawing){ return; }
