dojo.provide("davinci.review.drawing.tools.scaffolds.EllipseScaffold");

dojo.require("davinci.review.drawing.tools.scaffolds._ScaffoldCommon");
dojo.require("davinci.review.drawing.shapes.Ellipse");

dojo.declare("davinci.review.drawing.tools.scaffolds.EllipseScaffold", davinci.review.drawing.tools.scaffolds._ScaffoldCommon, {
	...
	createShape: function(x, y, attributeMap){
		this.shape = new davinci.review.drawing.shapes.Ellipse(this.surface, x, y, x + 1, y + 1, attributeMap);
