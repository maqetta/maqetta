dojo.provide("davinci.review.drawing.tools.scaffolds.TextScaffold");

dojo.require("davinci.review.drawing.tools.scaffolds._ScaffoldCommon");
dojo.require("davinci.review.drawing.shapes.Text");

dojo.declare("davinci.review.drawing.tools.scaffolds.TextScaffold", davinci.review.drawing.tools.scaffolds._ScaffoldCommon, {
	...
	createShape: function(x, y, attributeMap){
		this.shape = new davinci.review.drawing.shapes.Text(this.surface, x, y, x + 1, y + 1, attributeMap);
