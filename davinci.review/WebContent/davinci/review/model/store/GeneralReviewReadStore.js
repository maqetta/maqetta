dojo.provide("davinci.review.model.store.GeneralReviewReadStore");

dojo.declare("davinci.review.model.store.GeneralReviewReadStore", null, {
	...
	isItem: function(/* anything */ something){
		if(typeof something == "string"){
			...
			return dojo.some(this._loadedItems, function(item){
				if(something == this.getIdentity(item)){ return true; }
			}, this);
		}else if(something){
