...
//        },
        ...
        onFirstAdd: function(type, context) {
            ...
            //   first widget.
            var clipartBase = context.getLibraryBase('clipart', '1.0'),
                clipartPath = new davinci.model.Path(clipartBase),
                dojoBase = context.getLibraryBase('dojo', '1.7'),
                dojoPath = new davinci.model.Path(dojoBase).append('dojo/dojo.js'),
                path = clipartPath.relativeTo(dojoPath, true). toString();
            context.addJavaScriptText('require({ paths: { "clipart": "' + path + '" } });', true);
            return;
//        },
//        
