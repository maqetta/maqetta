dojo.provide("davinci.review.drawing.tools.scaffolds.RectangleScaffold");

dojo.require("davinci.review.drawing.tools.scaffolds._ScaffoldCommon");
dojo.require("davinci.review.drawing.shapes.Rectangle");

dojo.declare("davinci.review.drawing.tools.scaffolds.RectangleScaffold", davinci.review.drawing.tools.scaffolds._ScaffoldCommon, {
	...
	createShape: function(x, y, attributeMap){
		this.shape = new davinci.review.drawing.shapes.Rectangle(this.surface, x, y, x + 1, y + 1, attributeMap);
