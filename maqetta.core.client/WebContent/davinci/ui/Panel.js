define(["dojo/_base/declare", 
  ...
  ],function(declare, ContentPane, Dialog, CheckBox, List, ObjectStore, ArrayStore, ColorPalette, Tree, uiNLS, commonNLS){
	var davinci = {ui:{}};
	
	davinci.ui.Panel = declare("davinci.ui.Panel",ContentPane, {
...
//				var store=new dojo.data.ItemFileReadStore({data: { identifier: field.itemLabel,
			...
			if (field.labels)
			{
				...
				var storeData={  	labelMap: field.labels,
					...
					dataStore=new ObjectStore({data: storeData});
			...
			else
			{
				...
				dataStore=new ArrayStore({data: storeData});
		...
		createWidget : function (field,parms,fieldData,node,panel)
		{
			...
			div.onclick=function(){
				   ...
				   var okClicked=function (){
		   	        ...
		   	        palette = new ColorPalette({palette: "7x10",value:div.style.color, id: "progPalette",
		   	        	onChange:setColor});
