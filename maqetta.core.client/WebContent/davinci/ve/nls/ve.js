define({ root:
{
		...
		"manageStatesCheckCurrentStateOnly":"Check current state only",
		"manageStatesCheckAll":"Check all",
		"manageStatesUncheckAll":"Uncheck all",
