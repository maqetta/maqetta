define({ root:
{
		...
		"manageStates":"Manage States for Selected Widgets",
		"manageStatesWhichStates":"Currently selected widgets should be visible in which states:",
		"manageStatesNoVisibleWidgets":"Warning: no visible widgets, changes will have no effect",
		"manageStatesNoSelectedWidgets":"Warning: no selected widgets, changes will have no effect",
		"manageStatesCheckAccelerators":"Accelerators:",
		"manageStatesCheckCurrentStateOnly":"Current state only",
		"manageStatesCheckAll":"All states",
		"manageStatesUncheckAll":"No states",
