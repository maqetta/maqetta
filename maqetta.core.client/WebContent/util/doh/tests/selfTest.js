define(["doh/runner"], function(doh) {
  ...
  doh.register("myGroup2-3", f(1), 0, f(2));
  ...
  doh.register("myGroup2-15", {t5:f(0, "t5"), t6:f(0, "t6")}, 0, f(1));
  ...
  doh.register("myGroup2-19", {name:"t11", runTest:f(1, "t11")}, 0, f(2));
  ...
  doh.register("myGroup2-23", {name:"tx", runTest:f(2), setUp:f(1)}, 0, f(3));
  ...
  doh.register("myGroup2-27", {name:"tx", runTest:f(1), tearDown:f(2)}, 0, f(3));
  ...
  doh.register("myGroup2-31", {name:"tx", runTest:f(2), setUp:f(1), tearDown:f(3)}, 0, f(4));
  ...
  doh.register("doh/async", [{
    ...
    runTest: function(t){
      console.log("running test the SHOULD FAIL");
      var d = new doh.Deferred();
      setTimeout(function(){
