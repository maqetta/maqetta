package maqetta.core.server.orion.servlets;
...
import maqetta.core.server.orion.user.User;
...
public class UserManagerImpl implements IUserManager {
	...
	public IUser authenticate(HttpServletRequest req, HttpServletResponse resp) {
		String uid = FormAuthHelper.getAuthenticatedUser(req);
		if(uid!=null){
			String  userName = FormAuthHelper.getDefaultUserAdmin().getUser(UserConstants.KEY_UID, uid).getLogin();
