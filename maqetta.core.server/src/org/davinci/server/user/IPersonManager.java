...
public interface IPersonManager {
    ...
    public abstract Person addPerson(String userName, String password, String email) throws UserException;
    ...
    public abstract Person[] getPersons(String userName, int resultNumber, int start);
