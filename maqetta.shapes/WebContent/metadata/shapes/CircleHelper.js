...
return declare([], {
	create: function(widget, srcElement){
		...
		// of having width=height=0px (where user accepted the default size)
		...
		if(crprops || !computedStyleWidth || !computedStyleHeight){
			var oldStyleValues = widget.getStyleValues();;
			...
			domNode.style.backgroundColor = (domStyleFill && domStyleFill != '#000' && domStyleFill != '#000000' && domStyleFill != 'black' && domStyleFill != 'rgb(0,0,0)') ? 
					domStyleFill : (elementStyleFill ? elementStyleFill : 'transparent');
