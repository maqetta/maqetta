dojo.provide("davinci.libraries.oneui.oneui.form.CheckBoxListHelper");

dojo.declare("davinci.libraries.oneui.oneui.form.CheckBoxListHelper", null, {
	...
	getChildrenData: function(/*Widget*/ widget, /*Object*/ options){
		...
		if(store){
			...
			if(widget.options){
				...
				/* no idea why the value is not an array
