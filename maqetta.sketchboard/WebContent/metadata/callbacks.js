(function() {
	 ...
	 * 
	 */
	function SketchboardSceneManager(context) {
		this.context = context;
		//FIXME: How to do nls? Maybe need to convert callback.js to AMD and leverage AMD's I18N?
		this.name = 'Sketchboard'; //FIXME: Needs to be localized
	}
	
	SketchboardSceneManager.prototype = {
		id: 'Sketchboard',
		category: 'Sketchboard',
...
//        },
		onDocInit: function(context){
			debugger;
			var sm = new SketchboardSceneManager(context);
