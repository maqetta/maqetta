...
java -Dorg.eclipse.equinox.http.jetty.http.port=$port -Dmaqetta.localInstall=true "-Dmaqetta.baseDirectory=$absusersdir" -DloginUrl="/maqetta/welcome" -Dsmtp.mailServer=$smtpServer -jar "$jarFilePath" $consolePort -noExit -clean
