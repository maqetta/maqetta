...
mkdir -p "$absusersdir"
java -Dorg.eclipse.equinox.http.jetty.http.port=$port   -Dmaqetta.localInstall=true "-Dmaqetta.baseDirectory=$absusersdir" -DloginUrl="/maqetta/welcome" -jar "$jarFilePath" $consolePort -noExit
