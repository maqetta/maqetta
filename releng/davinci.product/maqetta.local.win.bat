...
java -Dorg.eclipse.equinox.http.jetty.http.port=%port%  -Dorg.eclipse.equinox.http.jetty.context.path=/maqetta -Dmaqetta.localInstall=true -Dmaqetta.baseDirectory="%usersdir%" -jar "%scriptdir%plugins\%EQUINOX%" -console -noExit
