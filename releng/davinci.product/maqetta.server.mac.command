...
mkdir -p "$absusersdir"
java -Dorg.eclipse.equinox.http.jetty.http.port=$port  -Dorg.eclipse.equinox.http.jetty.context.path=/maqetta -Dmaqetta.localInstall=false "-Dmaqetta.baseDirectory=$absusersdir" -DloginUrl="/maqetta/welcome"  -jar "$jarFilePath" -console -noExit
