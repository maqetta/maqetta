...
java -Dorg.eclipse.equinox.http.jetty.http.port=%port%  -Dmaqetta.localInstall=false -Dmaqetta.baseDirectory="%usersdir%" -DloginUrl="/maqetta/welcome" -Dsmtp.mailServer=$smtpServer %dwbUrl% -jar "%EQUINOX%" %consolePort% -noExit -clean
